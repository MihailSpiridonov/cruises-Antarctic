...
window.addEventListener('DOMContentLoaded', function () {
  ...
  document.addEventListener('keydown', _modules_menu_mobile_menu_mobile_js__WEBPACK_IMPORTED_MODULE_2__["openMenuKey"]); // Form validation
...
/*!***********************************************!*\
  !*** ./js/modules/menu-mobile/menu-mobile.js ***!
  \***********************************************/
/*! exports provided: buttonHumburger, menuNav, body, overlay, openMenu, openMenuKey */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
var hideMenuClickPast = function hideMenuClickPast(evt) {
...
var openMenuKey = function openMenuKey(evt) {
  if (evt.which === 32 && menuNav.classList.contains('header--close') && buttonHumburger.classList.contains('button-toggle--focus') || evt.which === 13 && menuNav.classList.contains('header--close') && buttonHumburger.classList.contains('button-toggle--focus')) {
    ...
    for (var _i = 0; _i < menuLink.length; _i++) {
      menuLink[_i].addEventListener('click', hideMenu);
    }
  }
};
