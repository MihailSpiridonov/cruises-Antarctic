...
/* harmony import */ var _modules_menu_mobile_menu_mobile_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./modules/menu-mobile/menu-mobile.js */ "./js/modules/menu-mobile/menu-mobile.js");
/* harmony import */ var _modules_form_validation_form_validation_js__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./modules/form-validation/form-validation.js */ "./js/modules/form-validation/form-validation.js");
/* harmony import */ var _modules_ModalBooking_ModalBooking_js__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./modules/ModalBooking/ModalBooking.js */ "./js/modules/ModalBooking/ModalBooking.js");
...
window.addEventListener('DOMContentLoaded', function () {
  Object(_utils_ios_vh_fix__WEBPACK_IMPORTED_MODULE_0__["iosVhFix"])(); // Модальное окно

  if (_modules_ModalBooking_ModalBooking_js__WEBPACK_IMPORTED_MODULE_4__["cruises"].length > 0) {
    for (var i = 0; i < _modules_ModalBooking_ModalBooking_js__WEBPACK_IMPORTED_MODULE_4__["cruises"].length; i++) {
      var cruise = _modules_ModalBooking_ModalBooking_js__WEBPACK_IMPORTED_MODULE_4__["cruises"][i];
      Object(_modules_ModalBooking_ModalBooking_js__WEBPACK_IMPORTED_MODULE_4__["manageModalBooking"])(cruise);
    }
  } // Меню (навигация)


  _modules_menu_mobile_menu_mobile_js__WEBPACK_IMPORTED_MODULE_2__["menuNav"].classList.remove('header--nojs');
  _modules_menu_mobile_menu_mobile_js__WEBPACK_IMPORTED_MODULE_2__["menuNav"].classList.add('header--close');
  _modules_menu_mobile_menu_mobile_js__WEBPACK_IMPORTED_MODULE_2__["buttonHumburger"].classList.add('button-toggle--close');
  _modules_menu_mobile_menu_mobile_js__WEBPACK_IMPORTED_MODULE_2__["buttonHumburger"].addEventListener('click', _modules_menu_mobile_menu_mobile_js__WEBPACK_IMPORTED_MODULE_2__["openMenu"]);
  document.addEventListener('keydown', _modules_menu_mobile_menu_mobile_js__WEBPACK_IMPORTED_MODULE_2__["openMenuKey"]);
  document.addEventListener('keydown', _modules_menu_mobile_menu_mobile_js__WEBPACK_IMPORTED_MODULE_2__["closeMenuKey"]); // Form validation

  _modules_form_validation_form_validation_js__WEBPACK_IMPORTED_MODULE_3__["form"].addEventListener('submit', _modules_form_validation_form_validation_js__WEBPACK_IMPORTED_MODULE_3__["formSend"]); // Плавный скролл по якорям из навигации

  var anchors = document.querySelectorAll('[data-nav-link]');
...
/***/ "./js/modules/ModalBooking/ModalBooking.js":
/*!*************************************************!*\
  !*** ./js/modules/ModalBooking/ModalBooking.js ***!
  \*************************************************/
/*! exports provided: cruises, manageModalBooking */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "cruises", function() { return cruises; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "manageModalBooking", function() { return manageModalBooking; });
/* harmony import */ var _menu_mobile_menu_mobile_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../menu-mobile/menu-mobile.js */ "./js/modules/menu-mobile/menu-mobile.js");

var cruises = document.querySelectorAll('[data-cruise]');
var modalBooking = document.querySelector('[data-booking]');
var modalBookingClose = modalBooking.querySelector('[data-booking--close]');
var scroll = 0; // Открытие popup

var showModalBooking = function showModalBooking() {
  scroll = window.pageYOffset;
  modalBooking.classList.add('open');
  _menu_mobile_menu_mobile_js__WEBPACK_IMPORTED_MODULE_0__["body"].classList.add('page__body--overlay');
  _menu_mobile_menu_mobile_js__WEBPACK_IMPORTED_MODULE_0__["overlay"].classList.remove('visually-hidden');
  _menu_mobile_menu_mobile_js__WEBPACK_IMPORTED_MODULE_0__["overlay"].classList.add('page__overlay');
...
var hideModalBookingKey = function hideModalBookingKey(evt) {
...
var hideModalBooking = function hideModalBooking() {
  window.scrollTo(0, scroll);
  modalBooking.classList.remove('open');
  _menu_mobile_menu_mobile_js__WEBPACK_IMPORTED_MODULE_0__["body"].classList.remove('page__body--overlay');
  _menu_mobile_menu_mobile_js__WEBPACK_IMPORTED_MODULE_0__["overlay"].classList.remove('page__overlay');
  _menu_mobile_menu_mobile_js__WEBPACK_IMPORTED_MODULE_0__["overlay"].classList.add('visually-hidden');
...
var hideModalBookingESC = function hideModalBookingESC(evt) {
  if (evt.which === 27) {
    window.scrollTo(0, scroll);
    modalBooking.classList.remove('open');
    _menu_mobile_menu_mobile_js__WEBPACK_IMPORTED_MODULE_0__["body"].classList.remove('page__body--overlay');
...
var hideModalBookingClickPast = function hideModalBookingClickPast(evt) {
...
function manageModalBooking(cruise) {
  var button = cruise.querySelector('[data-button]');
...
/***/ "./js/modules/menu-mobile/menu-mobile.js":
/*!***********************************************!*\
  !*** ./js/modules/menu-mobile/menu-mobile.js ***!
  \***********************************************/
/*! exports provided: buttonHumburger, menuNav, body, overlay, openMenu, openMenuKey, closeMenuKey */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "buttonHumburger", function() { return buttonHumburger; });
...
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "openMenuKey", function() { return openMenuKey; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "closeMenuKey", function() { return closeMenuKey; });
var menuNav = document.querySelector('[data-header]');
var nav = menuNav.querySelector('[data-nav]');
var menuLink = menuNav.querySelectorAll('[data-nav-link]');
var buttonHumburger = menuNav.querySelector('[data-button-toggle]');
var body = document.querySelector('[data-body]');
var overlay = document.querySelector('[data-overlay]'); // Функция показа мобильного меню
...
var openMenuKey = function openMenuKey(evt) {
...
var closeMenuKey = function closeMenuKey(evt) {
